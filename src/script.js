...
document.addEventListener("DOMContentLoaded", () => {
    ...
    autocompleteDropdown.className = 'mt-3 absolute top-full left-0 right-0 bg-[var(--popup-bg)] border border-gray-600 rounded-[var(--border-radius)] max-h-72 overflow-y-auto z-50 shadow-lg hidden';
